...
class CustomerProfileForm(forms.ModelForm):
    class Meta:
        model = Customer
        fields = ['first_name', 'last_name','gender','country','state','city','area_name','street_name','house_no']
        widgets = {'first_name':forms.TextInput(attrs={'class':'form-control'}),
                   ...
                   'city':forms.Select(attrs={'class':'form-control'}),'area_name':forms.TextInput(attrs={'class':'form-control'}),
